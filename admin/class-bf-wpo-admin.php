...
class BF_WPO_Dequeuer_Admin {
    ...
    ?>
        <div class="wrap">
            ...
            <p>You can copy&paste it wherever you want (I recommend a plugin instead of your theme's functions.php)</p>
            <p>BTW, you don't need this code if you keep <em>BF WPO Dequeuer</em> activated!</p>
            <br>
            <pre><?php
